...
/**
 * This script runs Vitest tests for the WebSocketServer module
...
const testPattern = './tests/unit/services/WebSocketServer.test.ts';

// Config file path (relative to project root)
const configPath = './test-config/vitest/vitest.config.mjs';

console.log(`✨ Running WebSocketServer tests with Vitest`);
