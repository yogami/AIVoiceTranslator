 ...
 */
export function translateSpeech(audioBuffer, sourceLanguage, targetLanguage, preTranscribedText) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            // Delegate to the service implementation
            return [2 /*return*/, translateSpeechService(audioBuffer, sourceLanguage, targetLanguage, preTranscribedText)];
        });
    });
}
